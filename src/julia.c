...
static void	ft_show(t_fractol *fractol)
{
	...
	mlx_string_put(fractol->mlx, fractol->window, c, k + 80,
		0xFFFFFF, "'k': increase Julia constant value");
	mlx_string_put(fractol->mlx, fractol->window, c, k + 100,
		0xFFFFFF, "'j': decrease Julia constant value");
	mlx_string_put(fractol->mlx, fractol->window, c, k + 120,
		0xFFFFFF, "Esc : close the application");
	mlx_string_put(fractol->mlx, fractol->window, c, k + 140,
